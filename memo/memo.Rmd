...
```{r add_total_gallons_per_square_foot_clean}
fuels <- fuels |>
...
fuels |>
  filter(Building == "Blair Tyson" & Year >= 2019 & Year <= 2023) |>
  group_by(Month) |>
  #View() |>
