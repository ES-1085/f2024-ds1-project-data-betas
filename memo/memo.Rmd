...
main_total_fuels <- main_total_fuels |>
  add_row(Building = "Other", Total_Gallons = 0)
...
fuels |>
  filter(Building == "Blair Tyson" & Year != 2024) |>
  group_by(Year) |>
  #View() |>
  mutate(Total_Gallons_per_Year = sum(Gallons)) |>
...
# fuels |>
#   group_by(Building) |>
#   mutate(Other = sum(Total_Gallons_per_Building)) |>
#   View()

ggplot(fuels, aes(x = "", y = Total_Gallons_per_Building, fill = Building)) +
