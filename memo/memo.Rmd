...
```{r clean-1a, message = FALSE, warning = FALSE}
...
```{r clean-1b, message = FALSE, warning = FALSE}
...
```{r clean-1c, message = FALSE, warning = FALSE}
fuels <- fuels |>
left_join(area)
```
...
```{r change-delivery-date-and-remove-top-row, message = FALSE, warning = FALSE}
fuels <- fuels |>
...
```{r change-tank-number, message = FALSE, warning = FALSE}
fuels <- fuels |>  
...
```{r change-cost, message = FALSE, warning = FALSE}
fuels <- fuels |>
...
```{r standardize-fuel-type, message = FALSE, warning = FALSE}
fuels <- fuels |>  
...
```{r change-gallons-and-unit-cost, message = FALSE, warning = FALSE}
fuels <- fuels |>
...
```{r add-year-month, message = FALSE, warning = FALSE}
fuels <- fuels |>
...
```{r change-to-numeric, message = FALSE, warning = FALSE}
fuels <- fuels |>
...
```{r progression-of-fuel-use-area-chart, fig.alt = "Area graph showing the progression of total fuel consumption on campus between 2014 and 2023. The fill color of the graph indicates the building, highlighting the top 7 consumers: Arts & Science + Gates, Kaelber, Blair Tyson, Davis Village, Seafox, Dorr Natural History Museum and Davis Center. Fuel consumption started at just over 60,000 in 2014, and is down to around 50,000 in 2023, with a peak in 2019 at around 70,000."}
